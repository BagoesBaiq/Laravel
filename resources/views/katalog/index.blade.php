...
<head>
    ...
    function openRecipeModal(index) {
        try {
            ...
            const productRegion = card.querySelector('.text-gray-600').textContent;
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                document.getElementById('results-count').textContent =
                    `Menampilkan ${visibleCount} makanan`;
                ...
                <div class="product-card card-hover card-gradient rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 flex flex-col h-[500px]"
                    ...
                    <div class="flex flex-col flex-grow">
                        <div class="space-y-3 flex-grow">
                            <h2 class="text-xl font-bold text-gray-800 group-hover:text-purple-600 transition-colors duration-300 line-clamp-1">
                                {{ $item->nama }}
                            </h2>
                ...
                <div class="inline-block w-full max-w-2xl p-6 my-8 text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                    ...
                    <div class="mt-2">
                        ...
                        <div class="mt-6 flex justify-center">
                            <!-- Removed the button for PDF download -->
                        </div>
                    </div>
                </div>
            </div>
